...
//                    magneticalPower.magnet = new MagneticSquare(this.gameObject);
...
//        SquareCreator.createSquare(this.transform.position, this.transform.lossyScale, , this.transform.parent);
//        PickupSound();
